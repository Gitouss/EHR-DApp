...
contract HealthRecords{
	...
	function newContact(string storage _symptoms, string storage _medications, string storage _allergies, uint storage _weight, uint storage _height) external returns (uint contactID) {
	...
	function getContact(uint contactID) view external returns (string memory _symptoms, string memory _medications, string memory _allergies, uint _weight, uint _height) {
	...
	function updateContact(uint contactID, string storage _symptoms, string storage _medications, string storage _allergies, uint _weight, uint _height) external {
